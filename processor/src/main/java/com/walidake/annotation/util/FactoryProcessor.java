package com.walidake.annotation.util;
...
public class FactoryProcessor extends AbstractProcessor {
	...
	public boolean process(Set<? extends TypeElement> annotations,
		...
		try {
			...
			for (Element annotatedElement : roundEnv
				...
				// Checks if id is conflicting with another @Factory annotated
	 ...
	 */
	private void checkValidClass(FactoryAnnotatedClass item) throws Exception {

		// Cast to TypeElement, has more type specific methods
		TypeElement classElement = item.getTypeElement();

		if (!classElement.getModifiers().contains(Modifier.PUBLIC)) {
			throw new Exception("The class %s is not public.");
		}
